                    ...
                    <div class="block rounded-lg">
                        <form method="POST" action="" align="center">
                            <div class="form-group">
                                ...
                                <input type="text" name="username" value="<?php echo $row['username']?>" style="width:40%;height:35px;">
                            </div>
                            <div class="form-group">
                                <p style="margin-bottom:3px">Password</p>
                                <input type="password" name="password" value="<?php echo $row['password']?>" style="width:40%;height:35px;">
                            </div>
                            <div class="form-group">
                                <p style="margin-bottom:3px">ชื่อ</p>
                                <input type="text" name="name" value="<?php echo $row['member_name']?>" style="width:40%;height:35px;">
                            </div>
                            <div class="form-group">
                                <p style="margin-bottom:3px">Email</p>
                                <input type="email" name="email" value="<?php echo $row['member_email']?>" style="width:40%;height:35px;">
                            </div>
                            <div class="form-group">
                                <p style="margin-bottom:3px">เบอร์โทรศัพท์</p>
                                <input type="tel" name="phone" value="<?php echo $row['member_phone']?>" style="width:40%;height:35px;">
                            </div>
                            <div class="form-group">
                                <input class="btn btn-primary" type="submit" name="submit" value="Update">
                                <a href="member.php" class="btn btn-danger" href="">ยกเลิก</a>
                            </div>
                        </form>
                    </div>
                </div>
...
if(isset($_POST['submit'])){
    ...
    $email = $_POST['email'];
    $phone = $_POST['phone'];
    $obj->update($username,$password,$name,$email,$phone,$id);
}
